> Archived design record — implementation plan + design spec(s) merged during the inc5-package-integrations doc consolidation; see the ADR / runbook / PR referenced below for shipped status.
