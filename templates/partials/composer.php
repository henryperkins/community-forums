...
<form method="post" action="/t/<?= (int) $thread['id'] ?>/reply" class="composer reply-composer<?= $replyExpanded ? ' is-expanded' : '' ?>" id="reply" data-composer-context="reply" data-composer-target-id="<?= (int) $thread['id'] ?>">
    <?= $this->csrfField() ?>
