> Archived design record — implementation plan + design spec(s) merged during the inc6-enforcement-cutover doc consolidation; see the ADR / runbook / PR referenced below for shipped status.
