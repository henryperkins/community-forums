...
|---|---|---|
| GA-DOD-03 | `docs/evidence/phase5/p5-16-runbook-rehearsals.md` + `docs/evidence/backup-restore/rehearsal.log` | Evidence collected and linked from requirement ledger |
| GA-DOD-17 | `docs/evidence/phase5/p5-16-browser-a11y-nojs.md` | Evidence collected and linked from requirement ledger |
| GA-DOD-18 | `docs/evidence/phase5/performance-budgets.md` | Evidence collected and linked from requirement ledger |
| GA-DOD-19 | `docs/evidence/phase5/p5-16-runbook-rehearsals.md` | Evidence collected and linked from requirement ledger |
