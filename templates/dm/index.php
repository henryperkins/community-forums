...
<div class="dm-shell">
    <?= $this->partial('partials/dm_list', ['conversations' => $conversations, 'filter' => $filter ?? 'all', 'active_id' => null, 'q' => $q ?? '', 'allow_groups' => $allow_groups ?? false, 'show_avatars' => $show_avatars ?? true]) ?>
