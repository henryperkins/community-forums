...
> **Status: Phase 4 (advanced community & content) — engineering closeout complete with explicit deferrals.** Phase 4 adds topic workflow, public tag lifecycle + board/tag follows, windowed/board leaderboards backed by `reputation_events`, and private board/bookmark folders plus saved feed filters as default-on features graduated 2026-07-01, all reversible via the `features` override. It also includes deploy-dark group-DM membership/reporting hardening, advanced Markdown tables/task lists/rules, follower removal, and community-memory summaries/related/wiki rollback. The current automated suite is green at **866 tests / 4519 assertions**. Large rich-expression/Gate-B surfaces (previews, custom emoji, expanded non-image files, slash commands/GIFs, automated context, custom profile fields, split/merge services, custom badge rules, and reference cards) are explicitly deferred in [`docs/adr/0003-phase-4-closeout-deferrals.md`](docs/adr/0003-phase-4-closeout-deferrals.md). See [`PHASE_4_STATUS.md`](PHASE_4_STATUS.md), [`docs/evidence/phase4-gate-a.md`](docs/evidence/phase4-gate-a.md), and [`docs/design-system/imladris/ACTIVATED_FEATURES.md`](docs/design-system/imladris/ACTIVATED_FEATURES.md) for the evidence and design-system mapping.
