...
| S39 | `ds-base.js` / `support.js` | **constraint** | Every screen loads the dc-runtime harness | PRODUCT_DESIGN.md §6.14 forbids shipping prototype runtime code | Never port. Reference only. | low |
...
- **Tested by**: nothing executes. Reviewed against ADR 0023 item 6, ADMIN.md §9.2/§9.4, PRODUCT_DESIGN.md
