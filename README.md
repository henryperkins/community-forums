...
> **Status: Phase 4 (advanced community & content) — engineering closeout complete with explicit deferrals.** Phase 4 adds deploy-dark topic workflow, group-DM membership/reporting hardening, advanced Markdown tables/task lists/rules, public tag lifecycle + board/tag follows, windowed/board leaderboards backed by `reputation_events`, follower removal, and community-memory summaries/related/wiki rollback. The automated suite is green at **456 tests / 1635 assertions** (PHP 8.5). Large rich-expression/Gate-B surfaces (previews, polls, custom emoji, expanded non-image files, slash commands/GIFs, automated context, profile organization polish, split/merge services, custom badge rules, and reference cards) are explicitly deferred in [`docs/adr/0003-phase-4-closeout-deferrals.md`](docs/adr/0003-phase-4-closeout-deferrals.md). See [`PHASE_4_STATUS.md`](PHASE_4_STATUS.md) and [`docs/evidence/phase4-gate-a.md`](docs/evidence/phase4-gate-a.md) for the evidence index.
