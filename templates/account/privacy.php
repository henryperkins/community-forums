...
<div class="settings-screen">
    ...
    <div class="settings">
        <?= $this->partial('partials/settings_nav', ['active' => 'privacy']) ?>

        <div class="settings-pane">
    <form method="post" action="/settings/privacy" class="stacked scribe-panel">
        <h2 class="scribe-panel-head">Who can see you</h2>
        <?= $this->csrfField() ?>
        <div class="field-grid">
            ...
            <label class="field">
                <span>Direct messages from</span>
        ...
        <div class="switch-stack">
            <div>
                <label class="switchline"><input class="switch" type="checkbox" role="switch" name="show_presence" value="1"<?= $showPresence ? ' checked' : '' ?>><span class="switch-text">Show when I'm online</span></label>
                <p class="switch-sub">A leaf marks your presence beside your name.</p>
            </div>
            <div>
                <label class="switchline"><input class="switch" type="checkbox" role="switch" name="hide_from_leaderboard" value="1"<?= $hideLb ? ' checked' : '' ?>><span class="switch-text">Hide me from leaderboards</span></label>
                <p class="switch-sub">You still earn regard; you just won't be ranked publicly.</p>
            </div>
            <div>
                <label class="switchline"><input class="switch" type="checkbox" role="switch" name="discoverable_by_email" value="1"<?= $discoverable ? ' checked' : '' ?>><span class="switch-text">Let others find me by email</span></label>
            </div>
        </div>
